...
input_path = '/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/brenda_ec'
#2) Path in which you wish to store all EC files:
output_path = '/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/brenda'
...
dir_files.sort()
# dir_files =['EC3.1.1.109_KcatKm.txt']
...
for i in dir_files:
    ...
    elif var_name == 'KcatKm':
        variable  = '#kcatKmValue*'
