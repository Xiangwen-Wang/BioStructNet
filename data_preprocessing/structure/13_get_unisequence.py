...
# This python script is to obtain protein sequence for each Kcat entries in python 2
...
def uniprotID_entry() :
    with codecs.open("/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/KCAT_combination.tsv", "r", encoding='utf-8') as file :
    ...
    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/uniprotID_entry.json', 'w') as outfile :
        json.dump(uniprotID_seq, outfile, indent=4)

def uniprotID_noseq() :
    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/uniprotID_entry.json', 'r') as infile :
    ...
    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/uniprotID_entry_all.json', 'w') as outfile :
        json.dump(uniprotID_seq, outfile, indent=4)
...
def nouniprotID_entry_brenda() :
    with open("/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/KCAT_combination.tsv", "r") as file :
        combination_lines = file.readlines()[1:]
    ...
    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/nouniprotID_entry_brenda.json', 'w') as outfile :
...
def combine_sequence() :
    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/uniprotID_entry.json', 'r') as file1:
        uniprot_file1 = json.load(file1)

    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/nouniprotID_entry_brenda.json', 'r') as file3:  # By BRENDA API
        nouniprot_file3 = json.load(file3)

    with codecs.open("/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/KCAT_combination.tsv", "r", encoding='utf-8') as file4 :
        ...
        try:  # local variable 'RetrievedSeq' referenced before assignment
            ...
            if len(RetrievedSeq) == 1 and EnzymeType != 'wildtype':
                ...
                if len(mutant1[0]) != len(mutant2):
                    ...
                    n += 1
                    print(
                        str(n) + '---------------------------')  # some are mapped, some are not mapped. R234G/R234K (60, 43 mapped, 17 not mapped)
    ...
    with open('/Users/xw0201/Desktop/postdoc/CPI_structure_CALB/Large_Dataset/allec/KCAT/KCAT_uniseq.json', 'w') as outfile :
        json.dump(entries, outfile, indent=4)
